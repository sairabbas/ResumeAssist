...
class QuestionnaireForm(FlaskForm):
    ...
    projectDescription = TextAreaField('Project Description: Use 3 Bullets', validators=[DataRequired(), Length(min=10, max=500)])
    ...
    projectDescription2 = TextAreaField('Project Description: Use 3 Bullets')
    ...
    projectDescription3 = TextAreaField('Project Description: Use 3 Bullets')
    ...
    workDescription2 = TextAreaField('Work Description: Use 3 Bullets', validators=[Optional()])
    ...
    workDescription3 = TextAreaField('Work Description: Use 3 Bullets', validators=[Optional()])
